...
class acf_options_page_plugin
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->settings = array(
			'title' => __('Настройки сайта','acf'), // title / menu name ('Site Options')
		...
		add_action('admin_menu', array($this,'admin_menu'), 0, 0);
	...
	*/
	...
	{	
		...
		if( isset($_POST['acf_nonce']) && wp_verify_nonce($_POST['acf_nonce'], 'input') )
		{
			...
			$this->data['admin_message'] = 'Настройки обновлены';
		}
				...
				<div class="inner-sidebar" id="side-info-column">
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<input type="submit" class="acf-button" value="<?php _e("Сохранить",'acf'); ?>" />
							<?php echo $this->data['admin_message']; ?>
						</div>
					</div>

...
class acf_field_gallery extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->l10n = array(
			'select'		=>	__("Добавить логотип партнера to Gallery",'acf'),
			'edit'			=>	__("Изменить логотип партнера",'acf'),
			'update'		=>	__("Обновить логотип партнера",'acf'),
			'uploadedTo'	=>	__("загруженные в эту запись",'acf'),
			'count_0'		=>	__("Не выбрано",'acf'),
			'count_1'		=>	__("1 выбрано",'acf'),
			'count_2'		=>	__("%d выбрано",'acf'),
		);
...
<div class="acf-gallery" data-preview_size="<?php echo $field['preview_size']; ?>" data-library="<?php echo $field['library']; ?>">
			...
			<div class="thumbnail" data-id="<?php echo $attachment['id']; ?>">
				...
				<div class="inner clearfix">
					...
					<div class="list-data">
						<table>
							...
							<tr>
								<th><label>Ссылка на Youtube:</label></th>
								<td class="td-description"><?php the_field('ссылка_на_youtube',$attachment['id']); ?></td>
							</tr>
							</tbody>
						</table>
					</div>
					<?php if (get_field('ссылка_на_youtube',$attachment['id'])) { ?>
					<div class="vide0"></div>
					<style>
						.vide0{
							position:absolute;
							...
							width:30px;
							height:30px;
							background-image: url('<?php echo site_url(); ?>/youtube.png');
				...
				<div class="hover">
					<ul class="bl">
						...
						<li><a href="#" class="acf-button-edit ir"><?php _e("Изменить",'acf'); ?></a></li>
					</ul>
				</div>
	...
	<div class="toolbar">
		<ul class="hl clearfix">
			<li class="add-image-li"><a class="acf-button add-image" href="#"><?php _e("Добавить логотип партнера",'acf'); ?></a></li>
